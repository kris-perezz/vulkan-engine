...
namespace kopi {
  ...
  void
  EngineDevice::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT &createInfo) {
    createInfo                 = {};
  ...
  void EngineDevice::hasGflwRequiredInstanceExtensions() {
    ...
    LOG_DEBUG("Avaialable extensions:");
  ...
  void EngineDevice::createBuffer(VkDeviceSize size,
  ...
  void EngineDevice::copyBufferToImage(VkBuffer buffer,
                                       VkImage image,
                                       uint32_t width,
                                       uint32_t height,
                                       uint32_t layerCount) {
